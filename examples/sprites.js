window.onload = () => {
  ...
  addNinniku = function (mX, mY) {
    let ninniku = Composites.stack(mX, mY, 1, 1, 0, 0, function (x, y) {
  ...
  Events.on(mouseConstraint, 'mousedown', function (event) {
    if (Math.random() > 0.5) {
      ...
      addNinniku(event.mouse.mousedownPosition.x, event.mouse.mousedownPosition.y);
    }
  });
